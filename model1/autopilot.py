...
if __name__ == "__main__":
    ...
    while (time <= 10000):
        ...
        # rocket.fly(0.5, 30)
        if (o_st.x <= 100000):
            rocket.alpha += radians(0.82)
            rocket.fly(0.5, 26.2)
        else:
            rocket.autopilot(0.5, o_st)
            # if (not rocket.fly(0.5, 0)):
            #     pygame.quit()
            #     quit()
        #print(sqrt(rocket.a_y ** 2 + rocket.a_x ** 2))
        #print(rocket.m_fuel)
